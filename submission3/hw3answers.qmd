...
Both graphs are overall decreasing average packs sold from 1970 to 2020. However, there is a clear difference between the two from 1970 to 1980. In the states with the lowest price increases, sales were still increasing from 1970 to 1980. After 1980, sales started to decline, but at a slower rate than the 5 states with the highest price increase. This makes sense with common laws of demand and supply; demand will decrease with price increases, but at a higher rate with higher price increases. 
...
The coefficient for log prices (-0.8094384) represents the estimated change in log sales for a one percent increase in log prices. A one percent increase in pirce decreases sales by 0.809%. This coefficient is also highly significant, with another very small p value, suggesting a negative relationship between log prices and log sales.
...
Coefficient for Log Prices (Price Elasticity): The estimated coefficient for log prices is -0.7955235. This coefficient represents the estimated change in log sales for a one percent increase in log prices, considering the influence of the instrument. This is again intuative because as price increases, sales would decrease, in this case by 0.79%. It is highly significant (small p value), suggesting a negative relationship between log prices and log sales, indicating that as log prices increase, log sales tend to decrease.
...
The coefficient for log prices (-0.9968136) represents the estimated change in log sales for a one percent increase in log prices. A one percent increase in pirce decreases sales by 0.99%. It is a nearly one to one realtionship in this time period. This coefficient is also highly significant, with another very small p value. 
...
The estimated coefficient for log prices is -1.150084. This coefficient represents the estimated change in log sales for a one percent increase in log prices, considering the influence of the instrument. So, sales decrease by -1.15% when price increases by 1%. So, this is an elastic good. 
...
The coefficient for log prices remains consistently strongly negative across both time periods. It becomes even more negative in 1991-2015, by about 0.19 for the elasticity model, 0.3 for the IV model. So, as time went on, the coefficients got even more negative, proving that the good is becoming more elastic over time. 

The instrument is much stronger in the second period, which makes sense because that is when the biggest tax increases happened. 
...
This analysis is intuative because more recently, we have become aware of the health issues with cigarette smoking. It makes sense that the good is becoming more elastic because we are more aware that cigarettes are bad so we are becoming more price-sensitive. 
